...
// Light Theme Colors
val BloodRed = Color(0xFFDE0909)       // Primary color - Emergency red
val PlasmaOrange = Color(0xFFFF5252)   // Secondary color - Vibrant accent
val TrustBlue = Color(0xFFF32152)      // Tertiary color - Medical blue
...
val NightBlue = Color(0xFFD21944)      // Dark theme tertiary
...
val wait = Color(0xFFFFFFFF)         // White color
// Accent Colors
